...
public interface EquipmentSpecRepository extends JpaRepository<EquipmentSpec, UUID> {

    List<EquipmentSpec> findByModelAndProductionYearAndRetrofitType(String model, Integer productionYear, RetrofitType retrofitType);
